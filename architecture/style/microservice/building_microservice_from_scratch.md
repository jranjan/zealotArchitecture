...
![Domain model](/microservice/images/building-micro-service/genetic-domain.jpg)
...
![Simplistic design](/microservice/images/building-micro-service/genetic-service-design-1.jpg)

## Separating business logic from cross cutting concerns <a name="monolith-system-concern-separation">

![Seperating cross cutting concenrs](/microservice/images/building-micro-service/genetic-service-design-2.jpg)
...
![Segregation of responsibilities](/microservice/images/building-micro-service/genetic-service-design-3a.jpg)

> Let us represent same using usage of microservice vocabulary.

![Microservices for specific bounded context](/microservice/images/building-micro-service/genetic-service-design-3b.jpg)
...
![Interaction among microservices](/microservice/images/building-micro-service/genetic-service-design-3c.jpg)
...
![Dashboard](/microservice/images/building-micro-service/genetic-service-design-4a.jpg)
...
![Dashboard](/microservice/images/building-micro-service/genetic-service-design-4b.jpg)
...
![Usage of loadbalancer of API gateway](/microservice/images/building-micro-service/genetic-service-design-5a.jpg)

> ### Usage of service specific loadbalancer instances

![Service specific loadbalancer](/microservice/images/building-micro-service/genetic-service-design-5b.jpg)
...
![API gateway cache](/microservice/images/genetic-service-design-6a.jpg)
...
![Service centric cache](/microservice/images/building-micro-service/genetic-service-design-6b.jpg)
...
![Service centric cache and API gateway cache](/microservice/images/building-micro-service/genetic-service-design-6c.jpg)
...
![Cardinal relationship](/microservice/images/building-micro-service/genetic-service-cardinal-relationship.jpg)

If we apply the above concept then we might end up our repo structure something like as mentioned below.

![Repository structure](/microservice/images/building-micro-service/microservice-repository-structure.png)


# Deployment strategy <a name="deployment">

![Work in progress](/microservice/images/general/work-in-progress.png)
...
![Microservice next](/microservice/images/building-micro-service/genetic-service-design-next.jpg)
